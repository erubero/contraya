  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-inter">
      ...
      <main className="max-w-3xl mx-auto px-5 py-16 prose prose-sm prose-slate dark:prose-invert max-w-none">
        ...
        <p>Contraya was built by a lawyer for people who are not lawyers. That is a statement about who designed the product, not an offer of legal services, and it does not make anyone at Contraya your attorney. For advice about your situation, consult a licensed attorney in your jurisdiction.</p>

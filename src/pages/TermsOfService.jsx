  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-inter">
      ...
      <main className="max-w-3xl mx-auto px-5 py-16 prose prose-sm prose-slate dark:prose-invert max-w-none">
        ...
        <p>The AI model is operated by <strong>Anthropic PBC</strong>, not by us. To produce a summary or answer a question, Contraya sends a copy of the document you selected to Anthropic. We ask for your permission in the app before this happens for the first time, and you can withdraw it at any time under Settings, AI and Your Data. Withdrawing it stops the sending and leaves the rest of the Service, including manual contract entry and date reminders, available to you. What is sent, what is not, and how Anthropic handles it are set out in our <a href="/privacy">Privacy Policy</a>.</p>

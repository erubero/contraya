  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-inter">
      ...
      <main className="max-w-3xl mx-auto px-5 py-16 prose prose-sm prose-slate dark:prose-invert max-w-none">
        ...
        <p>When you ask Contraya to read a contract, <strong>a copy of that document is sent to an outside company</strong> whose AI model writes your summary. That company is our data processor, and it is the only third party that ever receives the contents of your documents.</p>
        <ul>
          ...
          <li><strong>What is not sent:</strong> your email address, your name, and your account identifier. The company is not told whose document it is.</li>
          <li><strong>Who receives it:</strong> a United States provider of commercial AI model services, acting as our data processor under a commercial agreement. Under that agreement the content is not used to train its models, and inputs and outputs are deleted after a limited retention period. See <a href="https://www.anthropic.com/legal/privacy" target="_blank" rel="noopener noreferrer">that company's privacy policy</a>.</li>
        ...
        <ul>
          ...
          <li>To read your document and produce its summary when you add a contract, which means sending it to our AI processor as described in Section 1</li>
        ...
        <ul>
          <li><strong>Our AI processor</strong> (AI processing), the outside company described in Section 1, receives the documents you ask Contraya to read and the questions you ask Ask Contry, in order to produce your summaries and answers. This requires your permission first, as described in Sections 1 and 5.</li>
        ...
        <p>Before Contraya sends any document out, the app asks you for permission on a screen that says the document is sent to an outside company to be read, lists what will be sent, lists what will not, and states how it is handled. Nothing is sent unless you tap to allow it. Declining does not lock you out of the app: you can still add contracts, enter their details yourself, and get date reminders.</p>
        <p>You can withdraw your permission at any time in the app, under <strong>Settings, AI and Your Data</strong>. From that moment Contraya stops sending documents and questions out. Summaries produced before you withdrew stay in your account until you delete them, and you can delete any contract, or your whole account, whenever you like.</p>

...
export const BUILT_BY = 'Built by a lawyer, for everyday people.';
...
export const ABOUT_SUMMARIES_PARAGRAPHS = [
  ...
  'Contraya was built by a lawyer, for everyday people. That is why it explains rather than advises, and it does not change what follows.',

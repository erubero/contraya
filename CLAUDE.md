...
- Free tier: 2 analyses LIFETIME (`FREE_ANALYSIS_LIFETIME_LIMIT`); premium 15 analyses/month (`PRO_MONTHLY_ANALYSES`) + 50 Ask Contry questions/month (`PRO_MONTHLY_CHATS`, chat is premium-only); server ceilings 40 analyses + 300 questions/month in the edge functions. An analysis costs ~$0.15-0.50 in tokens; a chat question ~$0.02-0.05 after the cache write.
